...
<template>
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200 dark:bg-slate-900 dark:border-slate-500">
            <div>
        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 dark:bg-slate-900">
            <div class="p-6">
            ...
            <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l dark:border-slate-500">
                <div class="flex items-center">
            ...
            <div class="p-6 border-t border-gray-200 dark:border-slate-500">
                <div class="flex items-center">
            ...
            <div class="p-6 border-t border-gray-200 md:border-l dark:border-slate-500">
                <div class="flex items-center">
